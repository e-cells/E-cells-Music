...
const isCompact = computed(() => isGeckoView && window.innerWidth < 600);

const effectiveShowAlbum = computed(() => props.showAlbum && !isCompact.value);
const effectiveShowDuration = computed(() => props.showDuration && !isCompact.value);
...
const rowGridTemplate = computed(() =>
  buildSongListGridTemplate({
    ...
    showAlbum: effectiveShowAlbum.value,
    showDuration: effectiveShowDuration.value,
      ...
      <div :style="visibleBlockStyle">
        ...
        >
          ...
          >
            ...
            <Button
              v-if="effectiveShowAlbum && !showLyricColumn"
              variant="unstyled"
              size="none"
              type="button"
            ...
            <div
              v-if="showLyricColumn && effectiveShowAlbum"
